 ...
 */
/**
 * Servlet implementation class SelectStudentOne2
 */
@WebServlet("/SelectStudentOne2")
public class SelectStudentOne2 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		ResultSet re2 = JDBCUtil.executeQuery(sql, name1);
