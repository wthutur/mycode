 ...
 */
/**
 * Servlet implementation class SelectStudentOne3
 */
@WebServlet("/SelectStudentOne3")
public class SelectStudentOne3 extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		String sql = "select * from notice where phone=?;";
		ResultSet re2 = JDBCUtil.executeQuery(sql, phone1);
